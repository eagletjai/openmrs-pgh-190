								...
								<tr class='${status.index % 2 == 0 ? "evenRow" : "oddRow"}'>
									...
									<td class="encounterView" align="center">
										<c:if test="${showViewLink}">
											...
											<c:choose>
											    <c:if test="${enc.canView}"> <!-- begin: Meta Healthcare -->
												...
												</c:if> <!-- end: Meta Healthcare -->
												<c:if test="${enc.canEdit}"> <!-- begin: Meta Healthcare -->
											...
											<c:if test="${enc.canEdit or enc.canView}"> <!-- begin: Meta Healthcare -->
