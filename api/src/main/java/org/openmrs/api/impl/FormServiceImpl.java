...
public class FormServiceImpl extends BaseOpenmrsService implements FormService {
	...
	/**
	 * @see org.openmrs.api.FormService#getRolePermissions()
	 */
	public HashMap<Integer, HashMap<String, String>> getRolePermissions() throws APIException {
		return dao.getRolePermissions();
	}
